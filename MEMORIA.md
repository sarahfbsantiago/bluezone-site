...
WhatsApp flutuante: ícone em pontilhismo (branco brilhante no escuro, colorido no claro) com "chame a gente!" digitando em cima. Número: 5531993341543.
...
- **Tema**: claro é o padrão ao entrar no site (mudado em 12/09/2026; antes era o escuro); escuro é escolha do visitante (lembrada). Tudo que for feito precisa funcionar nos dois.
