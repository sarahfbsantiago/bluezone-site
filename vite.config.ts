...
const CLEAN_PAGES = ['bluenews/admin', 'bluenews', 'blueprint'] // o mais específico primeiro
...
export default defineConfig({
  ...
  build: { rollupOptions: { input: { main: resolve(__dirname, 'index.html'), bluenews: resolve(__dirname, 'bluenews.html'), blueprint: resolve(__dirname, 'blueprint.html'), bluenewsAdmin: resolve(__dirname, 'bluenews-admin.html') } } },
})
